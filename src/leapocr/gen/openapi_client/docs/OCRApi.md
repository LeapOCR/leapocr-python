...
------------- | ------------- | -------------
[**get_job_result**](OCRApi.md#get_job_result) | **GET** /ocr/result/{job_id} | Get OCR job result
[**get_job_status**](OCRApi.md#get_job_status) | **GET** /ocr/status/{job_id} | Get OCR job status
[**presigned_upload**](OCRApi.md#presigned_upload) | **POST** /ocr/uploads/presigned | Presigned upload
[**upload_from_url**](OCRApi.md#upload_from_url) | **POST** /ocr/uploads/url | Public URL upload


# **get_job_result**
> ModelsOCRResultResponse get_job_result(job_id, page=page, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get OCR job result
        api_response = api_instance.get_job_result(job_id, page=page, limit=limit)
        print("The response of OCRApi->get_job_result:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OCRApi->get_job_result: %s\n" % e)
```
...
# **get_job_status**
> StatusResponse get_job_status(job_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OCRApi->get_job_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OCRApi->get_job_status: %s\n" % e)
```
...
# **presigned_upload**
> UploadPresignedUploadResponse presigned_upload(upload_initiate_upload_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Presigned upload
        api_response = api_instance.presigned_upload(upload_initiate_upload_request)
        print("The response of OCRApi->presigned_upload:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OCRApi->presigned_upload: %s\n" % e)
```
...
# **upload_from_url**
> UploadURLUploadResponse upload_from_url(upload_url_upload_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Public URL upload
        api_response = api_instance.upload_from_url(upload_url_upload_request)
        print("The response of OCRApi->upload_from_url:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OCRApi->upload_from_url: %s\n" % e)
```
