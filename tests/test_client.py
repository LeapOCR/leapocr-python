...
from leapocr.types import Job, JobResult, JobStatus, ProcessFormat, ProcessTier
...
class TestLeapOCRClient:
    ...
    def test_process_url_success(self, mock_gen_client):
        ...
        mock_gen_client.return_value.upload_from_url_with_http_info.return_value = (
            mock_response
        )
    ...
    def test_process_url_api_error(self, mock_gen_client):
        ...
        # Mock API exception
        mock_gen_client.return_value.upload_from_url_with_http_info.side_effect = (
    ...
    def test_handle_api_error_422(self):
        ...
        client = LeapOCRClient(api_key="test_key")
        error = ApiException(
            status=422, reason="Validation Error", body={"detail": "Invalid input"}
        )
    ...
    def test_upload_file_success(self, mock_gen_client):
        ...
        mock_gen_client.return_value.presigned_upload_with_http_info.return_value = (
    ...
    def test_get_job_status_success(self, mock_gen_client):
        ...
        mock_gen_client.return_value.get_job_status_with_http_info.return_value = (
            mock_response
        )
    ...
    def test_get_job_result_success(self, mock_gen_client):
        ...
        mock_gen_client.return_value.get_job_result_with_http_info.return_value = (
            mock_response
        )
